...
def generate_launch_description():
    ...
    package_name='simulador_gazebo' #<--- CHANGE ME

    rsp = IncludeLaunchDescription(
                PythonLaunchDescriptionSource([os.path.join(
                    get_package_share_directory(package_name),'launch','rsp_front.launch.py'
    ...
    world = input("Ingrese el mundo a cargar: ")
    world_file_path = os.path.join(get_package_share_directory(package_name), 'worlds', world)
