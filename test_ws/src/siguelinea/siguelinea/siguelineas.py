...
class LineaPublisher(Node):
    ...
    def run(self):
        while True:
            try:
                ...
                #frame = self.rotate_image_and_remove_borders(frame, 90)
    ...
    def rotate_image_and_remove_borders(self, img, angle):
        ...
        # Threshold the image (any pixel value less than 1 will be set to 255 (white) and all others will be set to 0 (black))
